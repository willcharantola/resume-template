...
\section{Experiência}
    ...
    \subsection*{\texorpdfstring{
            \textbf{Prefeitura Municipal de Três Lagoas} \hfill Mato Grosso do Sul
        }{
    ...
    \textit{Desenvolvedor Front-end \hfill 2025 - 2026}
        \begin{itemize}
            ...
            \item Link do Projeto: https://linguas-indigenas.github.io/projeto/
        \end{itemize}
...
\section{Habilidades}
    ...
    \begin{itemize}
        \item \textbf{Tecnologias de Desenvolvimento Front-end:}  HTML | CSS | Javascript | Typescript | React.js | C | SQL | Node.js |
