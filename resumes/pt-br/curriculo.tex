...
\section{Habilidades}
   ...
   \section{Projetos de Destaque} 
    ...
    \textit{Desenvolvedor Full Stack \hfill 2022 - Atual}
        \begin{itemize}
            \item Desenclvimento de uma aplicação web responsiva para a transparência e divulgação dos resultados dos instrumentos de planejamento municipais utilizando React e Vite[cite: 10, 16].
            ...
            \item Link do Projeto: \href{https://planejamentotl.github.io/programa_metas/}{https://planejamentotl.github.io/programa_metas/} [cite: 23]
    ...
    \textit{Desenvolvedor Front-end \hfill 2025 - 2026}
        \begin{itemize}
            \item Criação de uma interface web moderna com React e Vite dedicada à valorização e divulgação de estudos sobre as línguas indígenas do Mato Grosso do Sul[cite: 18, 19, 21].
            ...
            \item Link do Projeto: \href{https://linguas-indigenas.github.io/projeto/{https://linguas-indigenas.github.io/projeto/} [cite: 23]
        \end{itemize}
