...
\section{Habilidades}
   ...
   \section{Projetos de Destaque} 
    ...
    \subsection*{\texorpdfstring{
            \textbf{Programa de Metas} \hfill Três Lagoas, MS
        }{
            Programa de Metas -- Três Lagoas, MS
        }}
        \begin{itemize}
            \item Desenclvimento de uma aplicação web responsiva para a transparência e divulgação dos resultados dos instrumentos de planejamento municipais utilizando React e Vite.
            \item Implementação de gráficos dinâmicos para visualização de dados complexos, tornando a apresentação das metas mais intuitiva para o cidadão.
    ...
    \subsection*{\texorpdfstring{
        ...
        \begin{itemize}
            \item Criação de uma interface web moderna com React e Vite dedicada à valorização e divulgação de estudos sobre as línguas indígenas do Mato Grosso do Sul.
            \item Desenvolvimento de componentes reutilizáveis e design responsivo planejado no Figma para garantir acessibilidade em diversos dispositivos.
            \item Link do Projeto: \href{https://linguas-indigenas.github.io/projeto/{https://linguas-indigenas.github.io/projeto/} 
        \end{itemize}
