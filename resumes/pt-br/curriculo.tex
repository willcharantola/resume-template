...
\section{Projetos de Destaque} 
    ...
    \subsection*{\texorpdfstring{
        ...
        \begin{itemize}
            \item Criação de uma interface web moderna com React e Vite dedicada à valorização e divulgação de estudos sobre as línguas indígenas do Mato Grosso do Sul[cite: 21].
            ...
            \item Link do Projeto: \href{https://linguas-indigenas.github.io/projeto/}{linguas-indigenas.github.io/projeto/} [cite: 23]
        \end{itemize}
